 ...
 * database.
 *
 * CBlock(hash=00000ffd590b14, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=e0028e, nTime=1640256382, nBits=1e0ffff0, nNonce=2235216, vtx=1)
...
{
    const char* pszTimestamp = "The Yngvarr Time 23 12 2021";
    const CScript genesisOutputScript = CScript() << ParseHex("049cc352199d80b4799687dc5bf72bbc7d0e2c3dd43bf6f962332038df20c998da930f353d221fc11d7f07b1ee485bd104689914c264aa4df4c3e7b79204c18077") << OP_CHECKSIG;
...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 2250000; 
        ...
        consensus.defaultAssumeValid = uint256S("0x00000bf6821f35c76e046c896dd917ffc2721b68b399095b4a2948d7c65896a5"); 
        ...
        genesis = CreateGenesisBlock(1640256382, 2235216, 0x1e0ffff0, 1, 20 * COIN);
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000bf6821f35c76e046c896dd917ffc2721b68b399095b4a2948d7c65896a5"));
        assert(genesis.hashMerkleRoot == uint256S("0xef4fbd93c0d6abd21b5ffec87b0ea1a995178925e74e78b97bef87892dd7d1a8"));
        ...
        vSeeds.emplace_back("node.oroworld.info");
        ...
        // LuckyCoinORO BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xB2, 0x1E};
        // LuckyCoinORO BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xAD, 0xE4};

        // LuckyCoinORO BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        vSporkAddresses = {"YPsZu6ANzZZL7zA2AeVgVhmw5M1fHYuD2V"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = {
            {
                {0, uint256S("0x00000bf6821f35c76e046c896dd917ffc2721b68b399095b4a2948d7c65896a5")},
            }
        };

        chainTxData = ChainTxData{
            1640256382, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x000001210b14633989bfcc9b59793e3f95654cf85a9f94857538451ccd3504dc"); 
        ...
        genesis = CreateGenesisBlock(1640256387UL, 807097UL, 0x1e0ffff0, 1, 20 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x000001210b14633989bfcc9b59793e3f95654cf85a9f94857538451ccd3504dc"));
        assert(genesis.hashMerkleRoot == uint256S("0xef4fbd93c0d6abd21b5ffec87b0ea1a995178925e74e78b97bef87892dd7d1a8"));
        ...
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,206);
        // Testnet LuckyCoinORO BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Testnet LuckyCoinORO BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Testnet LuckyCoinORO BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
        ...
        vSporkAddresses = {"YZKMvH2i3UK17Lyf6n4M5zuGzMtLTD6bdV"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = {
            {
                {0, uint256S("0x000001210b14633989bfcc9b59793e3f95654cf85a9f94857538451ccd3504dc")},
            }
        };

        chainTxData = ChainTxData{
            1640256387, // * UNIX timestamp of last known number of transactions
            0,    // * total number of transactions between genesis and that timestamp
                        //   (the tx=... number in the SetBestChain debug.log lines)
            0        // * estimated number of transactions per second after that timestamp
        };
...
public:
    CDevNetParams(bool fHelpOnly = false) {
        ...
        genesis = CreateGenesisBlock(1640256392, 2, 0x207fffff, 1, 20 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x1b23e831ac997e4c44f26659ec1e410800b145ef5e17f67736031da491bb1810"));
        assert(genesis.hashMerkleRoot == uint256S("0xef4fbd93c0d6abd21b5ffec87b0ea1a995178925e74e78b97bef87892dd7d1a8"));
        ...
        checkpointData = (CCheckpointData) {
            {
                { 0, uint256S("0x1b23e831ac997e4c44f26659ec1e410800b145ef5e17f67736031da491bb1810")},
...
public:
    CRegTestParams() {
        ...
        // privKey: 7vCUJgzg14iwQky6MNGRHSjZuuCWYLQKQZtEmpEEccgQBpGNZQS
        vSporkAddresses = {"Yg2P3pQBVntKuyMP9QkCyAWLripJ7Bb2Xh"};
        nMinSporkKeys = 1;
        ...
        // Regtest LuckyCoinORO addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,78);
        // Regtest LuckyCoinORO script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,79);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,206);
        // Regtest LuckyCoinORO BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest LuckyCoinORO BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest LuckyCoinORO BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
