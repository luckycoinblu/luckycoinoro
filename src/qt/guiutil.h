...
/** Utility functions used by the LuckyCoinORO Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "luckycoinoro:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load luckycoinoro specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a luckycoinoro specific theme is activated (light/dark).*/
