...
"""Tests around luckycoinoro governance objects."""
...
class LuckyCoinOROGovernanceTest (LuckyCoinOROTestFramework):
    def set_test_params(self):
        self.set_luckycoinoro_test_params(2, 1)
...
if __name__ == '__main__':
    LuckyCoinOROGovernanceTest().main()
