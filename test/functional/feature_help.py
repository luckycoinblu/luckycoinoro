...
"""Verify that starting luckycoinorod with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start luckycoinorod with -h for help text")
        ...
        self.log.info("Start luckycoinorod with -version for version information")
