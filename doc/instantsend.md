...
This mechanism has been integrated into Bitcore-Node-LuckyCoinORO which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/luckycoinoropay/insight-api-luckycoinoro#web-socket-api](https://github.com/luckycoinoropay/insight-api-luckycoinoro#web-socket-api)
* API: [https://github.com/luckycoinoropay/insight-api-luckycoinoro#instantsend-transactions](https://github.com/luckycoinoropay/insight-api-luckycoinoro#instantsend-transactions)
