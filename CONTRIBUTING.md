Contributing to LuckyCoinORO Core
============================

The LuckyCoinORO Core project operates an open contributor model where anyone is
...
the pull request affects. Valid areas as:
  ...
  - *Qt* for changes to luckycoinoro-qt
...
[Translation Process](https://github.com/luckycoinoropay/luckycoinoro/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the LuckyCoinORO Core project (and related
projects such as libsecp256k1), and is not to be confused with overall LuckyCoinORO
Network Protocol consensus changes.

Whether a pull request is merged into LuckyCoinORO Core rests with the project merge
...
Patches that change LuckyCoinORO consensus rules are considerably more involved than
...
Where a patch set proposes to change the LuckyCoinORO consensus, it must have been
...
The review process is normally fairly responsive on the LuckyCoinORO Core repository, however
...
The project leader is the release manager for each LuckyCoinORO Core release.
