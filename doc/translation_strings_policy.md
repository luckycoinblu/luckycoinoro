...
This document provides guidelines for internationalization of the LuckyCoinORO Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `luckycoinoro_en.ts` remains unchanged.
