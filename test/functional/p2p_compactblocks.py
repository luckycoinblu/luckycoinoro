...
# TestP2PConn: A peer we use to send messages to luckycoinorod, and store responses.
...
class CompactBlocksTest(BitcoinTestFramework):
    ...
    # This test actually causes luckycoinorod to (reasonably!) disconnect us, so do this last.
    ...
    # luckycoinorod's choice of nonce.
    ...
    # Test that luckycoinorod requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for luckycoinorod to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # luckycoinorod will not send blocktxn responses for blocks whose height is
