...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the masternode owner LuckyCoinORO address\n"
            "  payee          - Print the masternode payout LuckyCoinORO address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the masternode operator public key\n"
            "  status         - Print masternode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the masternode voting LuckyCoinORO address\n"
        );
}
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    { "luckycoinoro",               "masternode",             &masternode,             {} },
    { "luckycoinoro",               "masternodelist",         &masternodelist,         {} },
};
