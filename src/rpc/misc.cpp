...
UniValue debug(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            " - \"luckycoinoro\" activates all LuckyCoinORO-specific categories at once;\n"
            ...
            "\nExamples:\n"
            + HelpExampleCli("debug", "luckycoinoro")
            + HelpExampleRpc("debug", "luckycoinoro+net")
        );
...
UniValue validateaddress(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "\nReturn information about the given luckycoinoro address.\n"
            ...
            "\nArguments:\n"
            "1. \"address\"                    (string, required) The luckycoinoro address to validate\n"
            "\nResult:\n"
            "{\n"
...
UniValue verifymessage(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 3)
        throw std::runtime_error(
            ...
            "\nArguments:\n"
            "1. \"address\"         (string, required) The luckycoinoro address to use for the signature.\n"
...
UniValue getaddressmempool(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "    \"satoshis\"  (number) The difference of Yngvarr\n"
...
UniValue getaddressutxos(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "    \"satoshis\"  (number) The number of Yngvarr of the output\n"
...
UniValue getaddressbalance(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "\nResult:\n"
            "{\n"
            "  \"balance\": xxxxx,              (numeric) The current total balance in Yngvarr\n"
            "  \"balance_immature\": xxxxx,     (numeric) The current immature balance in Yngvarr\n"
            "  \"balance_spendable\": xxxxx,    (numeric) The current spendable balance in Yngvarr\n"
            "  \"received\": xxxxx              (numeric) The total number of Yngvarr received (including change)\n"
            "}\n"
            "\nExamples:\n"
...
UniValue echo(const JSONRPCRequest& request)
{
    if (request.fHelp)
        throw std::runtime_error(
            ...
            "luckycoinoro-cli and the GUI. There is no server-side difference."
        );
...
static UniValue getinfo_deprecated(const JSONRPCRequest& request)
{
    throw JSONRPCError(RPC_METHOD_NOT_FOUND,
        ...
        "\nluckycoinoro-cli has the option -getinfo to collect and format these in the old format."
    );
}
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    /* LuckyCoinORO features */
    { "luckycoinoro",               "mnsync",                 &mnsync,                 {} },
    { "luckycoinoro",               "spork",                  &spork,                  {"arg0","value"} },
