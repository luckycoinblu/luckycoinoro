...
EXPECTED_HOLDER_NAMES = [
    ...
    "The LuckyCoinORO Core developers\n",
]
...
Arguments:
    <base_directory> - The base directory of a LuckyCoinORO Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The LuckyCoinORO Core developers'
...
Arguments:
    <base_directory> - The base directory of LuckyCoinORO Core source code repository.
"""
...
Arguments:
    <file> - A source file in the LuckyCoinORO Core repository.
"""
