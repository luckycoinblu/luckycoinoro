...
//! Interface for the src/evo part of a luckycoinoro node (luckycoinorod process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a luckycoinoro node (luckycoinorod process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a luckycoinoro node (luckycoinorod process).
...
//! Top-level interface for a luckycoinoro node (luckycoinorod process).
class Node
{
public:
    virtual ~Node() {}
